...
@interface MUIRegisterViewController () <MZTimerLabelDelegate, UITextFieldDelegate>
{
...
@implementation MUIRegisterViewController
...
//     还有导航栏的高度
    CGFloat maxY = kbRect.size.height - (SCREEN_HEIGHT * 0.5 - 150) + 44;
